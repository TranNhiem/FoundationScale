...
def check_rloo_requirements(
    *,
    ...
    every other family's role-map check (``check_role_map``) because a
    restated role-map check is one countable in several copies; only the
    origin differs per binding.
    """
