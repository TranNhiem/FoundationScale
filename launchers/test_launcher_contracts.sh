...
#
# Scope: the two GB200 launchers and the launchers/*.py helpers they drive. The
# self-tests for checks/*.py gates live in test_checks_gates.sh -- both suites
# must run for the anti-orphan gate to see a complete set of call sites.
