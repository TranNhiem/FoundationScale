...
FLOORS: dict[str, int] = {
    # DEBT -- 7 module(s) BELOW the default floor of 90.
    ...
    "src/foundationscale/rl/trainer.py": 82,  # set by --update; measured 82.7%
    ...
    "src/foundationscale/train/cli.py": 97,  # set by --update; measured 97.6%
