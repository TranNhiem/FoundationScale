...
FLOORS: dict[str, int] = {
    ...
    # RATCHET -- 44 module(s) ABOVE the default band. These record what
    ...
    "src/foundationscale/families/registry.py": 98,  # set by --update; measured 98.4%
    ...
    "src/foundationscale/topology.py": 97,  # set by --update; measured 97.7%
