...
FLOORS: dict[str, int] = {
    # DEBT -- 1 module(s) BELOW the default floor of 90.
    ...
    # RATCHET -- 54 module(s) ABOVE the default band. These record what
    ...
    "src/foundationscale/families/adapters.py": 100,  # set by --update; measured 100.0%
    "src/foundationscale/families/corpus.py": 98,  # set by --update; measured 98.9%
    ...
    "src/foundationscale/provenance/manifest.py": 95,  # set by --update; measured 95.2%
    ...
    "src/foundationscale/rl/group_policy.py": 100,  # set by --update; measured 100.0%
    ...
    "src/foundationscale/rl/structural.py": 99,  # set by --update; measured 99.4%
    "src/foundationscale/rl/trainer.py": 97,  # set by --update; measured 97.9%
