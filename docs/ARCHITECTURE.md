...
The RL plane is 29 modules; `src/foundationscale/rl/` measures 21683 lines and
...
`src/` is 50006 LOC across 62 files; `tests/` adds 76650 `.py` LOC (its
...
Repo-wide: 266343 git-tracked `.py`/`.sh`/`.md` lines.
