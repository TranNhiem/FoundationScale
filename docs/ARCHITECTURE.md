...
The RL plane is 27 modules; `src/foundationscale/rl/` measures 19268 lines and
...
`src/` is 41887 LOC across 52 files; `tests/` adds 62835 `.py` LOC (its
...
Repo-wide: 224543 git-tracked `.py`/`.sh`/`.md` lines.
