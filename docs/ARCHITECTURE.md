...
`src/` is 19576 LOC across 27 files; `tests/` adds 30631 `.py` LOC (its
...
| `launchers/` | The estate launch plane (10521 shell LOC) plus two bash contract suites and Python helpers (lora target census, peft override replay) — 1615 Python LOC. |
...
Repo-wide: 135324 git-tracked `.py`/`.sh`/`.md` lines.
