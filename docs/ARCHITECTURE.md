...
`src/` is 40525 LOC across 52 files; `tests/` adds 59173 `.py` LOC (its
...
| `launchers/` | The estate launch plane (12388 shell LOC) plus two bash contract suites and Python helpers (lora target census, peft override replay) — 1615 Python LOC. |
...
Repo-wide: 202473 git-tracked `.py`/`.sh`/`.md` lines.
