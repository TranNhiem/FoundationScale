...
`src/` is 41026 LOC across 52 files; `tests/` adds 60053 `.py` LOC (its
...
| `launchers/` | The estate launch plane (12813 shell LOC) plus two bash contract suites and Python helpers (lora target census, peft override replay) — 1615 Python LOC. |
...
Repo-wide: 208472 git-tracked `.py`/`.sh`/`.md` lines.
