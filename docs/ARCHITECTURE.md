...
The RL plane is 27 modules; `src/foundationscale/rl/` measures 19239 lines and
...
`src/` is 41687 LOC across 52 files; `tests/` adds 62430 `.py` LOC (its
...
Repo-wide: 216578 git-tracked `.py`/`.sh`/`.md` lines.
