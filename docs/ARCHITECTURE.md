...
The RL plane is 29 modules; `src/foundationscale/rl/` measures 21710 lines and
...
`src/` is 50094 LOC across 62 files; `tests/` adds 78483 `.py` LOC (its
...
Repo-wide: 268426 git-tracked `.py`/`.sh`/`.md` lines.
