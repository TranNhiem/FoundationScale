...
The RL plane is 27 modules; `src/foundationscale/rl/` measures 19313 lines and
...
`src/` is 42119 LOC across 52 files; `tests/` adds 63321 `.py` LOC (its
...
Repo-wide: 225261 git-tracked `.py`/`.sh`/`.md` lines.
