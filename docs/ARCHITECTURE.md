...
| `launchers/` | The estate launch plane (11320 shell LOC) plus two bash contract suites and Python helpers (lora target census, peft override replay) — 1615 Python LOC. |
...
Repo-wide: 183626 git-tracked `.py`/`.sh`/`.md` lines.
