...
The RL plane is 27 modules; `src/foundationscale/rl/` measures 19042 lines and
...
`src/` is 41434 LOC across 52 files; `tests/` adds 61525 `.py` LOC (its
...
Repo-wide: 211492 git-tracked `.py`/`.sh`/`.md` lines.
