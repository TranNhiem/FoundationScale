...
The RL plane is 27 modules; `src/foundationscale/rl/` measures 19145 lines and
...
`src/` is 41537 LOC across 52 files; `tests/` adds 61995 `.py` LOC (its
...
Repo-wide: 212065 git-tracked `.py`/`.sh`/`.md` lines.
