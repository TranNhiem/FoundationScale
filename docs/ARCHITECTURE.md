...
`src/` is 20039 LOC across 27 files; `tests/` adds 30802 `.py` LOC (its
...
| `launchers/` | The estate launch plane (10532 shell LOC) plus two bash contract suites and Python helpers (lora target census, peft override replay) — 1615 Python LOC. |
...
Repo-wide: 136363 git-tracked `.py`/`.sh`/`.md` lines.
