...
| `launcher-contracts` | `bash launchers/test_launcher_contracts.sh` | The launcher bash contract suites — 156 controls, 4 named abstentions |
| `checks-gates` | `bash launchers/test_checks_gates.sh` | The gate-script self-test legs — 47 controls, 1 named abstention |
