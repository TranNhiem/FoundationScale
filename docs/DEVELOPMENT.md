...
| `make launcher-contracts` | `bash launchers/test_launcher_contracts.sh` | 152 controls; 28.9s wall / 4.1s user, measured 2026-09-11 on an idle developer machine |
| `make checks-gates` | `bash launchers/test_checks_gates.sh` | 45 controls; 9.4s wall / 5.8s user, same conditions |
...
- `make launcher-contracts` runs `launchers/test_launcher_contracts.sh` — 152 controls,
...
- `make checks-gates` runs `launchers/test_checks_gates.sh` — 45 controls,
