...
plus 1615 Python LOC; `validation_campaigns/h100_validation/` (31917 .py LOC, 64 files) is a validation
...
- mypy checks `src` plus three named `tools/` files, and — since the `checks/`
  errors were cleared — all 9 files under `checks/`, via a second invocation
