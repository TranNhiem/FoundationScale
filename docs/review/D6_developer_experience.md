...
`src/foundationscale/` measures 40755 lines; `launchers/` contains 9500 shell LOC
plus 1615 Python LOC; `validation_campaigns/h100_validation/` (34169 .py LOC, 66 files) is a validation
...
- mypy checks `src` plus three named `tools/` files, and — since the `checks/`
  errors were cleared — all 16 files under `checks/`, via a second invocation
