...
188804 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(34169 .py LOC, 66 files); the package, `src/foundationscale/` measures 38402 lines; the
