...
119206 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `h100_validation/`
(31313 .py LOC, 63 files); the package, `src/foundationscale/` measures 18761 lines; the
GB200-side launch path, `launchers/*.sh` (9857 LOC, 5 files). No other countables appear
in this document.
