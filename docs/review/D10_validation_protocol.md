...
118040 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `h100_validation/`
(31313 .py LOC, 63 files); the package, `src/foundationscale/` measures 18706 lines; the
