...
129310 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(32388 .py LOC, 64 files); the package, `src/foundationscale/` measures 18915 lines; the
