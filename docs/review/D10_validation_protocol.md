...
131236 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(32995 .py LOC, 65 files); the package, `src/foundationscale/` measures 18915 lines; the
