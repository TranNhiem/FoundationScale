...
142253 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(33385 .py LOC, 65 files); the package, `src/foundationscale/` measures 21534 lines; the
GB200-side launch path, `launchers/*.sh` (10716 LOC, 7 files). No other countables appear
in this document.
