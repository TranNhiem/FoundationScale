...
123547 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(31313 .py LOC, 63 files); the package, `src/foundationscale/` measures 18915 lines; the
GB200-side launch path, `launchers/*.sh` (10263 LOC, 7 files). No other countables appear
in this document.
