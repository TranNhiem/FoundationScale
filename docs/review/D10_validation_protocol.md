...
176520 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(33385 .py LOC, 65 files); the package, `src/foundationscale/` measures 37236 lines; the
