...
179505 git-tracked .py/.sh/.md lines repo-wide; the validation harness, `validation_campaigns/h100_validation/`
(34167 .py LOC, 66 files); the package, `src/foundationscale/` measures 37655 lines; the
