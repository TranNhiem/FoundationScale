...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>41,537 LOC / 52 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>137 Python files / 61,995 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,904 LOC"]
  SRC["src/ as importer<br/>52 Python files / 41,537 LOC"]

  FS["src/foundationscale<br/>52 Python files / 41,537 LOC<br/>root __init__.py exports nothing"]
