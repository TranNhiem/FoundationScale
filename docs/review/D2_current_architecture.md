...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>19,576 LOC / 27 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
flowchart TB
  ...
  FS["src/foundationscale<br/>27 Python files / 19,576 LOC<br/>root __init__.py exports nothing"]
