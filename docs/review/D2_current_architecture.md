...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>28,596 LOC / 37 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>85 Python files / 40,869 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,533 LOC"]
  SRC["src/ as importer<br/>37 Python files / 28,596 LOC"]

  FS["src/foundationscale<br/>37 Python files / 28,596 LOC<br/>root __init__.py exports nothing"]
