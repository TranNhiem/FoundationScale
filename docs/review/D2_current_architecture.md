...
- The operational plane is shell and tool-heavy: `launchers/` contains 11,320 shell LOC plus 1,615 Python LOC, while `tools/` contains 9,533 Python LOC. `validation_campaigns/h100_validation/` adds another 34,167 Python LOC and 6,489 shell LOC.
...
| Launch orchestration | 11,320 shell LOC in `launchers/`; preflight is scoped to one Gemma-4-E4B / GB200-tray launch; census denominator control is hardwired to one launcher | **ESTATE-ONLY, not a package launcher API** |
