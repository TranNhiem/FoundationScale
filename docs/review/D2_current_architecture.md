...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>38,402 LOC / 50 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>121 Python files / 53,613 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,594 LOC"]
  SRC["src/ as importer<br/>50 Python files / 38,402 LOC"]

  FS["src/foundationscale<br/>50 Python files / 38,402 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"253 Python import statements"| FS
  TOOLS -->|"14 Python import statements"| FS
  SRC -->|"131 Python import statements, source not disaggregated"| FS
