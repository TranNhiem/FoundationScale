...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>42,119 LOC / 52 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>144 Python files / 63,321 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,972 LOC"]
  SRC["src/ as importer<br/>52 Python files / 42,119 LOC"]

  FS["src/foundationscale<br/>52 Python files / 42,119 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"302 Python import statements"| FS
