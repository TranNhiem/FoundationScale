...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>38,350 LOC / 50 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>120 Python files / 53,072 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,533 LOC"]
  SRC["src/ as importer<br/>50 Python files / 38,350 LOC"]

  FS["src/foundationscale<br/>50 Python files / 38,350 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"249 Python import statements"| FS
