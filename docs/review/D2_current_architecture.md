...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>40,755 LOC / 52 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>130 Python files / 59,307 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,904 LOC"]
  SRC["src/ as importer<br/>52 Python files / 40,755 LOC"]

  FS["src/foundationscale<br/>52 Python files / 40,755 LOC<br/>root __init__.py exports nothing"]
