...
- The operational plane is shell and tool-heavy: `launchers/` contains 10,387 shell LOC plus 1,615 Python LOC, while `tools/` contains 9,514 Python LOC. `validation_campaigns/h100_validation/` adds another 32,388 Python LOC and 5,088 shell LOC.
...
| Hardware validation plane | `validation_campaigns/h100_validation/` contributes 32,388 Python LOC and 5,088 shell LOC | **CODE PRESENT, estate-scoped; it is not an installed trainer** |
