...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>32,235 LOC / 41 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
flowchart TB
  ...
  FS["src/foundationscale<br/>41 Python files / 32,235 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"203 Python import statements"| FS
  TOOLS -->|"14 Python import statements"| FS
  SRC -->|"95 Python import statements, source not disaggregated"| FS
