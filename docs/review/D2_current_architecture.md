...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>35,516 LOC / 47 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
flowchart TB
  ...
  SRC["src/ as importer<br/>47 Python files / 35,516 LOC"]

  FS["src/foundationscale<br/>47 Python files / 35,516 LOC<br/>root __init__.py exports nothing"]
  ...
  SRC -->|"120 Python import statements, source not disaggregated"| FS
