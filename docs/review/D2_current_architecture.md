...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>42,296 LOC / 52 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>147 Python files / 63,932 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,972 LOC"]
  SRC["src/ as importer<br/>52 Python files / 42,296 LOC"]

  FS["src/foundationscale<br/>52 Python files / 42,296 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"307 Python import statements"| FS
