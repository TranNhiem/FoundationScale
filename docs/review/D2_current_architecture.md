...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>20,039 LOC / 27 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>69 Python files / 30,802 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,514 LOC"]
  SRC["src/ as importer<br/>27 Python files / 20,039 LOC"]

  FS["src/foundationscale<br/>27 Python files / 20,039 LOC<br/>root __init__.py exports nothing"]
