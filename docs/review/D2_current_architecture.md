...
- The operational plane is shell and tool-heavy: `launchers/` contains 11,862 shell LOC plus 1,615 Python LOC, while `tools/` contains 9,533 Python LOC. `validation_campaigns/h100_validation/` adds another 34,167 Python LOC and 6,489 shell LOC.
