...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>27,065 LOC / 36 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>82 Python files / 39,070 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,533 LOC"]
  SRC["src/ as importer<br/>36 Python files / 27,065 LOC"]

  FS["src/foundationscale<br/>36 Python files / 27,065 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"150 Python import statements"| FS
  TOOLS -->|"14 Python import statements"| FS
  SRC -->|"66 Python import statements, source not disaggregated"| FS
