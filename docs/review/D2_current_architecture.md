...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>37,024 LOC / 49 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>107 Python files / 48,462 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,533 LOC"]
  SRC["src/ as importer<br/>49 Python files / 37,024 LOC"]

  FS["src/foundationscale<br/>49 Python files / 37,024 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"229 Python import statements"| FS
