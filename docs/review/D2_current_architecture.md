...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>22,776 LOC / 33 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
flowchart TB
  ...
  SRC["src/ as importer<br/>33 Python files / 22,776 LOC"]

  FS["src/foundationscale<br/>33 Python files / 22,776 LOC<br/>root __init__.py exports nothing"]
