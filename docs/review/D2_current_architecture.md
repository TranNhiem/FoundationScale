...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>22,043 LOC / 32 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>74 Python files / 32,622 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,514 LOC"]
  SRC["src/ as importer<br/>32 Python files / 22,043 LOC"]

  FS["src/foundationscale<br/>32 Python files / 22,043 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"115 Python import statements"| FS
  TOOLS -->|"14 Python import statements"| FS
  SRC -->|"40 Python import statements, source not disaggregated"| FS
