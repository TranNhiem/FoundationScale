...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>22,726 LOC / 33 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
```mermaid
flowchart TB
  TESTS["tests/<br/>75 Python files / 33,483 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,533 LOC"]
  SRC["src/ as importer<br/>33 Python files / 22,726 LOC"]

  FS["src/foundationscale<br/>33 Python files / 22,726 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"121 Python import statements"| FS
