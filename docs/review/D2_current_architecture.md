...
flowchart TB
  ...
  PKG["[installed foundationscale package]<br/>41,735 LOC / 52 files<br/>verification plane + delegating train/ (1,305 LOC)<br/>0 training primitives, step loop rented from transformers.Trainer"]
...
flowchart TB
  ...
  SRC["src/ as importer<br/>52 Python files / 41,735 LOC"]

  FS["src/foundationscale<br/>52 Python files / 41,735 LOC<br/>root __init__.py exports nothing"]
