...
```mermaid
flowchart TB
  TESTS["tests/<br/>148 Python files / 64,184 LOC"]
  TOOLS["tools/<br/>31 Python files / 9,972 LOC"]
  SRC["src/ as importer<br/>52 Python files / 42,442 LOC"]

  FS["src/foundationscale<br/>52 Python files / 42,442 LOC<br/>root __init__.py exports nothing"]
  ...
  TESTS -->|"308 Python import statements"| FS
