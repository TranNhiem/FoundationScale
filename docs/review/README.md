...
`src/foundationscale/` measures 35,516 lines and implements **no training primitives of its
...
- It moved *during* the review. These documents were written against a census of 13,667 lines.
  ...
  landed since have added the rest: `src/foundationscale/` now measures 35,516 lines. The
