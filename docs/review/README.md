...
`src/foundationscale/` measures 37,534 lines and implements **no training primitives of its
...
- It moved *during* the review. These documents were written against a census of 13,667 lines.
  ...
  landed since have added the rest: `src/foundationscale/` now measures 37,534 lines. The
