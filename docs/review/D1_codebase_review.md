...
The census records 214770 git-tracked .py/.sh/.md lines repo-wide. The trees, from largest to smallest:
...
`src/foundationscale/` measures 41621 lines in the census's wording and is organised into six subpackages plus two top-level modules:
