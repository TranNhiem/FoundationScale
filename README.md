...
LOC, and `validation_campaigns/h100_validation/` adds another 32408 Python LOC and 5186 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 129428 git-tracked .py/.sh/.md lines repo-wide.
