...
`src/` = 50006 LOC across 62 files. `launchers/` contains 10231 shell LOC plus 1615 Python
LOC, and `validation_campaigns/h100_validation/` adds another 34169 Python LOC and 6706 shell LOC on top of the
package. `tools/` contains 10183 Python LOC. 266343 git-tracked .py/.sh/.md lines repo-wide.

```
src/foundationscale/   the package: gates/, checkpoint/, verify/, provenance/,
                       topology.py, models/, train/, integrate.py
tests/                 the test suite (76650 .py LOC); conftest carries the skip guard
