...
LOC, and `validation_campaigns/h100_validation/` adds another 32156 Python LOC and 4996 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 128977 git-tracked .py/.sh/.md lines repo-wide.
