...
LOC, and `validation_campaigns/h100_validation/` adds another 32520 Python LOC and 5582 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 129936 git-tracked .py/.sh/.md lines repo-wide.
