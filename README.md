...
LOC, and `validation_campaigns/h100_validation/` adds another 32520 Python LOC and 5531 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 129885 git-tracked .py/.sh/.md lines repo-wide.
