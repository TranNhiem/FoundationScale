...
LOC, and `validation_campaigns/h100_validation/` adds another 32520 Python LOC and 6397 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 130751 git-tracked .py/.sh/.md lines repo-wide.
