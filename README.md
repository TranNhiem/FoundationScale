...
`src/` = 32235 LOC across 41 files. `launchers/` contains 10231 shell LOC plus 1615 Python
LOC, and `validation_campaigns/h100_validation/` adds another 33385 Python LOC and 6414 shell LOC on top of the
package. `tools/` contains 9533 Python LOC. 167711 git-tracked .py/.sh/.md lines repo-wide.

```
src/foundationscale/   the package: gates/, checkpoint/, verify/, provenance/,
                       topology.py, models/, train/, integrate.py
tests/                 the test suite (45303 .py LOC); conftest carries the skip guard
