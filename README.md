...
LOC, and `validation_campaigns/h100_validation/` adds another 31917 Python LOC and 4996 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 128738 git-tracked .py/.sh/.md lines repo-wide.
