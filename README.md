...
LOC, and `validation_campaigns/h100_validation/` adds another 32299 Python LOC and 5088 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 129221 git-tracked .py/.sh/.md lines repo-wide.
