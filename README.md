...
LOC, and `validation_campaigns/h100_validation/` adds another 32995 Python LOC and 6407 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 131803 git-tracked .py/.sh/.md lines repo-wide.
