...
`src/` = 41146 LOC across 52 files. `launchers/` contains 10231 shell LOC plus 1615 Python
LOC, and `validation_campaigns/h100_validation/` adds another 34169 Python LOC and 6706 shell LOC on top of the
package. `tools/` contains 9904 Python LOC. 210050 git-tracked .py/.sh/.md lines repo-wide.

```
src/foundationscale/   the package: gates/, checkpoint/, verify/, provenance/,
                       topology.py, models/, train/, integrate.py
tests/                 the test suite (60538 .py LOC); conftest carries the skip guard
