...
LOC, and `validation_campaigns/h100_validation/` adds another 32241 Python LOC and 5036 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 129111 git-tracked .py/.sh/.md lines repo-wide.
