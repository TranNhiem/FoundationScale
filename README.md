...
LOC, and `validation_campaigns/h100_validation/` adds another 32075 Python LOC and 4996 shell LOC on top of the
package. `tools/` contains 9514 Python LOC. 128896 git-tracked .py/.sh/.md lines repo-wide.
