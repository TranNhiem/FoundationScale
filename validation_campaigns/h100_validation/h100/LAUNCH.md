...
> build plane is green at 43 stages (E.5). **This document tells you how to launch, and the
...
43 stages green, byte-identical across rebuilds). **Hand-editing any of them is
...
at 43 stages (E.5); the model-root resolver's 8/8 estate rows reproduce their independent
